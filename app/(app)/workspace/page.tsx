...
export default function MyAgentsPage() {
  return (
    <main>
      <section className="space-y-2 border-b border-grid px-5 sm:px-8 pt-6 pb-5">
        <p className="font-mono text-[10px] tracking-[0.14em] text-text-dim uppercase">
          Portfolio
        </p>
        <h1 className="font-mono text-[24px] sm:text-[30px] leading-none text-text-primary">My agents</h1>
