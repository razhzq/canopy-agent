...
export const RWA_RULES: RuleSpec[] = [
  ...
  // CROSS-ASSET (coverage plan step 9). BTC and SOL beside the candidate.
  {
    key: "btcTrendPct",
    labelKey: "rule_btcTrendPct",
    basis: "bars",
    periods: "20 vs 50",
    helpKey: "rule_btcTrendPct_help",
    op: "gte",
    value: 0,
    min: -20,
    max: 20,
  ...
  {
    key: "btcTrendPctMax",
    labelKey: "rule_btcTrendPctMax",
    basis: "bars",
    periods: "20 vs 50",
    helpKey: "rule_btcTrendPctMax_help",
    op: "lte",
    value: 0,
    min: -20,
    max: 20,
  ...
  {
    key: "btcChangePct",
    labelKey: "rule_btcChangePct",
    basis: "bars",
    periods: "1d",
    helpKey: "rule_btcChangePct_help",
    op: "lte",
    value: 0,
    min: -20,
    max: 20,
  ...
  {
    key: "btcChangePctMin",
    labelKey: "rule_btcChangePctMin",
    basis: "bars",
    periods: "1d",
    helpKey: "rule_btcChangePctMin_help",
    op: "gte",
    value: 0,
    min: -20,
    max: 20,
  ...
  {
    key: "solTrendPct",
    labelKey: "rule_solTrendPct",
    basis: "bars",
    periods: "20 vs 50",
    helpKey: "rule_solTrendPct_help",
    op: "gte",
    value: 0,
    min: -20,
    max: 20,
  ...
  {
    key: "solTrendPctMax",
    labelKey: "rule_solTrendPctMax",
    basis: "bars",
    periods: "20 vs 50",
    helpKey: "rule_solTrendPctMax_help",
    op: "lte",
    value: 0,
    min: -20,
    max: 20,
  ...
  {
    key: "solChangePct",
    labelKey: "rule_solChangePct",
    basis: "bars",
    periods: "1d",
    helpKey: "rule_solChangePct_help",
    op: "lte",
    value: 0,
    min: -20,
    max: 20,
  ...
  {
    key: "solChangePctMin",
    labelKey: "rule_solChangePctMin",
    basis: "bars",
    periods: "1d",
    helpKey: "rule_solChangePctMin_help",
    op: "gte",
    value: 0,
    min: -20,
    max: 20,
  ...
  {
    key: "relativeStrengthBtcPct",
    labelKey: "rule_relativeStrengthBtcPct",
    basis: "bars",
    periods: "20",
    helpKey: "rule_relativeStrengthBtcPct_help",
    op: "gte",
    value: 0,
    min: -50,
    max: 50,
  ...
  {
    key: "relativeStrengthBtcPctMax",
    labelKey: "rule_relativeStrengthBtcPctMax",
    basis: "bars",
    periods: "20",
    helpKey: "rule_relativeStrengthBtcPctMax_help",
    op: "lte",
    value: 0,
    min: -50,
    max: 50,
  ...
  {
    key: "relativeStrengthSolPct",
    labelKey: "rule_relativeStrengthSolPct",
    basis: "bars",
    periods: "20",
    helpKey: "rule_relativeStrengthSolPct_help",
    op: "gte",
    value: 0,
    min: -50,
    max: 50,
  ...
  {
    key: "relativeStrengthSolPctMax",
    labelKey: "rule_relativeStrengthSolPctMax",
    basis: "bars",
    periods: "20",
    helpKey: "rule_relativeStrengthSolPctMax_help",
    op: "lte",
    value: 0,
    min: -50,
    max: 50,
  ...
  // CANDLE PATTERNS (coverage plan step 8). Events aged in bars; crypto only,
  // like ATR, because a pattern needs the bar's high and low.
  {
    key: "bullishEngulfingBars",
    labelKey: "rule_bullishEngulfingBars",
    basis: "bars",
    helpKey: "rule_bullishEngulfingBars_help",
    op: "lte",
    value: 1,
    min: 0,
    max: 10,
  ...
  {
    key: "bearishEngulfingBars",
    labelKey: "rule_bearishEngulfingBars",
    basis: "bars",
    helpKey: "rule_bearishEngulfingBars_help",
    op: "lte",
    value: 1,
    min: 0,
    max: 10,
  ...
  {
    key: "hammerBars",
    labelKey: "rule_hammerBars",
    basis: "bars",
    helpKey: "rule_hammerBars_help",
    op: "lte",
    value: 1,
    min: 0,
    max: 10,
  ...
  {
    key: "shootingStarBars",
    labelKey: "rule_shootingStarBars",
    basis: "bars",
    helpKey: "rule_shootingStarBars_help",
    op: "lte",
    value: 1,
    min: 0,
    max: 10,
  ...
  {
    key: "dojiBars",
    labelKey: "rule_dojiBars",
    basis: "bars",
    helpKey: "rule_dojiBars_help",
    op: "lte",
    value: 1,
    min: 0,
    max: 10,
  ...
  {
    key: "insideBarBars",
    labelKey: "rule_insideBarBars",
    basis: "bars",
    helpKey: "rule_insideBarBars_help",
    op: "lte",
    value: 1,
    min: 0,
    max: 10,
  ...
  // SESSION AND CALENDAR (coverage plan step 7). The clock, in the strategy's
  // timezone. Static: no window, no bar size.
  {
    key: "hourOfDayMin",
    labelKey: "rule_hourOfDayMin",
    basis: "static",
    helpKey: "rule_hourOfDayMin_help",
    op: "gte",
    value: 9,
    min: 0,
    max: 23,
  ...
  {
    key: "hourOfDay",
    labelKey: "rule_hourOfDay",
    basis: "static",
    helpKey: "rule_hourOfDay_help",
    op: "lte",
    value: 15,
    min: 0,
    max: 23,
  ...
  {
    key: "dayOfWeekMin",
    labelKey: "rule_dayOfWeekMin",
    basis: "static",
    helpKey: "rule_dayOfWeekMin_help",
    op: "gte",
    value: 1,
    min: 1,
    max: 7,
  ...
  {
    key: "dayOfWeek",
    labelKey: "rule_dayOfWeek",
    basis: "static",
    helpKey: "rule_dayOfWeek_help",
    op: "lte",
    value: 5,
    min: 1,
    max: 7,
  ...
  // WINDOWS AND BREAKOUTS (coverage plan step 6). The window is the period,
  // so "in the last 4 hours" on 1h bars is period 4.
  {
    key: "momentum20dPctMax",
    labelKey: "rule_momentum20dPctMax",
    basis: "bars",
    periods: "20",
    helpKey: "rule_momentum20dPctMax_help",
    op: "lte",
    value: -5,
    min: -50,
    max: 50,
  ...
  {
    key: "breakHighPct",
    labelKey: "rule_breakHighPct",
    basis: "bars",
    periods: "20",
    helpKey: "rule_breakHighPct_help",
    op: "gte",
    value: 0,
    min: -20,
    max: 20,
  ...
  {
    key: "breakLowPct",
    labelKey: "rule_breakLowPct",
    basis: "bars",
    periods: "20",
    helpKey: "rule_breakLowPct_help",
    op: "lte",
    value: 0,
    min: -20,
    max: 20,
  ...
  {
    key: "priceCrossEmaUpBars",
    labelKey: "rule_priceCrossEmaUpBars",
    basis: "bars",
    periods: "20",
    helpKey: "rule_priceCrossEmaUpBars_help",
    op: "lte",
    value: 3,
    min: 0,
    max: 20,
  ...
  {
    key: "priceCrossEmaDownBars",
    labelKey: "rule_priceCrossEmaDownBars",
    basis: "bars",
    periods: "20",
    helpKey: "rule_priceCrossEmaDownBars_help",
    op: "lte",
    value: 3,
    min: 0,
    max: 20,
  ...
  {
    key: "priceCrossSmaUpBars",
    labelKey: "rule_priceCrossSmaUpBars",
    basis: "bars",
    periods: "20",
    helpKey: "rule_priceCrossSmaUpBars_help",
    op: "lte",
    value: 3,
    min: 0,
    max: 20,
  ...
  {
    key: "priceCrossSmaDownBars",
    labelKey: "rule_priceCrossSmaDownBars",
    basis: "bars",
    periods: "20",
    helpKey: "rule_priceCrossSmaDownBars_help",
    op: "lte",
    value: 3,
    min: 0,
    max: 20,
  ...
  {
    key: "barChangePct",
    labelKey: "rule_barChangePct",
    basis: "bars",
    periods: "1",
    helpKey: "rule_barChangePct_help",
    op: "lte",
    value: -1,
    min: -20,
    max: 20,
  ...
  {
    key: "barChangePctMin",
    labelKey: "rule_barChangePctMin",
    basis: "bars",
    periods: "1",
    helpKey: "rule_barChangePctMin_help",
    op: "gte",
    value: 1,
    min: -20,
    max: 20,
  ...
  {
    key: "volatilityChangePct",
    labelKey: "rule_volatilityChangePct",
    basis: "bars",
    periods: "14 · 5",
    helpKey: "rule_volatilityChangePct_help",
    op: "gte",
    value: 20,
    min: -100,
    max: 500,
  ...
  {
    key: "volatilityChangePctMax",
    labelKey: "rule_volatilityChangePctMax",
    basis: "bars",
    periods: "14 · 5",
    helpKey: "rule_volatilityChangePctMax_help",
    op: "lte",
    value: -20,
    min: -100,
    max: 500,
  ...
  // LAUNCH KEYS (CANOPY_100). Read off the live universe row, never off a
  // candle series, so a rule built from them can fire on a token minutes old.
  // Tokens only: a tokenized stock has no launch.
  {
    key: "launchAgeMinutes",
    labelKey: "rule_launchAgeMinutes",
    basis: "static",
    helpKey: "rule_launchAgeMinutes_help",
    op: "gte",
    value: 10,
    min: 0,
    max: 1440,
  ...
  {
    key: "launchAgeMinutesMax",
    labelKey: "rule_launchAgeMinutesMax",
    basis: "static",
    helpKey: "rule_launchAgeMinutesMax_help",
    op: "lte",
    value: 60,
    min: 0,
    max: 1440,
  ...
  {
    key: "changeSinceLaunchPct",
    labelKey: "rule_changeSinceLaunchPct",
    basis: "static",
    helpKey: "rule_changeSinceLaunchPct_help",
    op: "gte",
    value: 0,
    min: -95,
    max: 1000,
  ...
  {
    key: "changeSinceLaunchPctMax",
    labelKey: "rule_changeSinceLaunchPctMax",
    basis: "static",
    helpKey: "rule_changeSinceLaunchPctMax_help",
    op: "lte",
    value: 100,
    min: -95,
    max: 1000,
  ...
  {
    key: "drawdownFromLaunchHighPct",
    labelKey: "rule_drawdownFromLaunchHighPct",
    basis: "static",
    helpKey: "rule_drawdownFromLaunchHighPct_help",
    op: "gte",
    value: 20,
    min: 0,
    max: 95,
  ...
  {
    key: "liquidityGrowthPct",
    labelKey: "rule_liquidityGrowthPct",
    basis: "static",
    helpKey: "rule_liquidityGrowthPct_help",
    op: "gte",
    value: 0,
    min: -90,
    max: 1000,
  ...
  {
    key: "volume5mUsd",
    labelKey: "rule_volume5mUsd",
    basis: "static",
    helpKey: "rule_volume5mUsd_help",
    op: "gte",
    value: 1000,
    min: 0,
    max: 10000000,
  ...
  {
    key: "buySellRatio5m",
    labelKey: "rule_buySellRatio5m",
    basis: "static",
    helpKey: "rule_buySellRatio5m_help",
    op: "gte",
    value: 1.5,
    min: 0,
    max: 20,
  ...
  {
    key: "holderCount",
    labelKey: "rule_holderCount",
    basis: "static",
    helpKey: "rule_holderCount_help",
    op: "gte",
    value: 100,
    min: 0,
    max: 1000000,
  ...
  {
    key: "top10HolderPct",
    labelKey: "rule_top10HolderPct",
    basis: "static",
    helpKey: "rule_top10HolderPct_help",
    op: "lte",
    value: 30,
    min: 1,
    max: 100,
  ...
  {
    key: "creatorHoldingPct",
    labelKey: "rule_creatorHoldingPct",
    basis: "static",
    helpKey: "rule_creatorHoldingPct_help",
    op: "lte",
    value: 5,
    min: 0,
    max: 100,
  ...
  {
    key: "sellImpactPct",
    labelKey: "rule_sellImpactPct",
    basis: "static",
    helpKey: "rule_sellImpactPct_help",
    op: "lte",
    value: 3,
    min: 0.1,
    max: 50,
