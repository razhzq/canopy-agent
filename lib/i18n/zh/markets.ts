...
export const zhMarkets: Record<keyof typeof enMarkets, string> = {
  ...
  dsc_group_live: "此刻",
  dsc_group_live_note: "按几秒钟前的最新数据判断，仅针对通过以上条件中流动性最深的代币。",
  dsc_launchAgeMinutes: "上线时长",
  dsc_launchAgeMinutes_note: "自链上建池以来的分钟数。",
  dsc_volume5mUsd: "5 分钟成交额",
  dsc_txns5m: "5 分钟成交笔数",
  dsc_buySellRatio5m: "5 分钟买卖比",
  dsc_liquidityGrowthPct: "流动性增长",
  dsc_liquidityGrowthPct_note: "相对建池初始流动性。负值表示流动性在流出。",
  dsc_holderCount: "持有人数",
  dsc_top10HolderPct: "前十大持仓占比",
  dsc_top10HolderPct_note: "供应量中由前十大钱包持有的比例。越低越分散。",
  dsc_creatorHoldingPct: "创建者仍持有",
  dsc_creatorHoldingPct_note: "建池钱包仍持有的供应量比例。",
  dsc_sellImpactPct: "卖出 $100 的成本",
  dsc_sellImpactPct_note: "此刻 $100 一买一卖在池子里损耗的百分比。",
  dsc_require_sellable: "确实能卖出",
  dsc_require_sellable_note: "$100 买入并卖回此刻都能通过 Jupiter 路由。不满足的代币会被排除。",
  dsc_summary_sellable: "可卖出",
  dsc_unit_minutes: "分钟",
