...
export const zhStrategy: Record<keyof typeof enStrategy, string> = {
  ...
  rule_btcTrendPct: "BTC 趋势至少",
  rule_btcTrendPct_help: "BTC 自身 20/50 均线差，百分比。0 即“仅在 BTC 上升趋势中”。",
  rule_btcTrendPctMax: "BTC 趋势至多",
  rule_btcTrendPctMax_help: "上限形式：0 即“仅在 BTC 下降趋势中”。",
  rule_btcChangePct: "BTC 日涨跌至多",
  rule_btcChangePct_help: "BTC 最近 24 小时的涨跌。0 即“仅当 BTC 当日下跌”。",
  rule_btcChangePctMin: "BTC 日涨跌至少",
  rule_btcChangePctMin_help: "0 即“仅当 BTC 当日上涨”。",
  rule_solTrendPct: "SOL 趋势至少",
  rule_solTrendPct_help: "SOL 自身 20/50 均线差。0 即“仅在 SOL 上升趋势中”。",
  rule_solTrendPctMax: "SOL 趋势至多",
  rule_solTrendPctMax_help: "上限形式：0 即“仅在 SOL 下降趋势中”。",
  rule_solChangePct: "SOL 日涨跌至多",
  rule_solChangePct_help: "SOL 最近 24 小时的涨跌。0 即“仅当 SOL 当日下跌”。",
  rule_solChangePctMin: "SOL 日涨跌至少",
  rule_solChangePctMin_help: "0 即“仅当 SOL 当日上涨”。",
  rule_relativeStrengthBtcPct: "相对 BTC 强度至少",
  rule_relativeStrengthBtcPct_help: "代币涨跌减去 BTC 涨跌（同一窗口）。0 即“跑赢 BTC”。周期可另设。",
  rule_relativeStrengthBtcPctMax: "相对 BTC 强度至多",
  rule_relativeStrengthBtcPctMax_help: "0 即“跑输 BTC”。",
  rule_relativeStrengthSolPct: "相对 SOL 强度至少",
  rule_relativeStrengthSolPct_help: "代币涨跌减去 SOL 涨跌（同一窗口）。0 即“跑赢 SOL”。",
  rule_relativeStrengthSolPctMax: "相对 SOL 强度至多",
  rule_relativeStrengthSolPctMax_help: "0 即“跑输 SOL”。",
  rule_bullishEngulfingBars: "看涨吞没于",
  rule_bullishEngulfingBars_help: "看涨吞没形态（阳线实体覆盖前一根阴线实体）收盘距今几根 K 线。0 为上一根；1 为上一根或再前一根。",
  rule_bearishEngulfingBars: "看跌吞没于",
  rule_bearishEngulfingBars_help: "看跌吞没形态收盘距今几根 K 线。更常用作卖出信号。",
  rule_hammerBars: "锤子线于",
  rule_hammerBars_help: "锤子线（针形线）收盘距今几根 K 线——下影线至少为实体两倍，实体靠近区间顶部。",
  rule_shootingStarBars: "流星线于",
  rule_shootingStarBars_help: "流星线收盘距今几根 K 线——锤子线的镜像，上影线很长。",
  rule_dojiBars: "十字星于",
  rule_dojiBars_help: "十字星收盘距今几根 K 线——实体不超过全幅的十分之一。",
  rule_insideBarBars: "内包线于",
  rule_insideBarBars_help: "内包线收盘距今几根 K 线——整根 K 线位于前一根的高低点之内。",
  rule_hourOfDayMin: "最早买入时刻",
  rule_hourOfDayMin_help: "交易时段开始的当地小时（0–23），按策略时区计。9 配合“最晚时刻”15 即 9 点到 16 点的时段。",
  rule_hourOfDay: "最晚买入时刻",
  rule_hourOfDay_help: "当地一天中代理可买入的最后一个整点。“到下午 4 点”为 15，因为 16 点那一小时已在四点之后。",
  rule_dayOfWeekMin: "最早星期",
  rule_dayOfWeekMin_help: "1 为周一，7 为周日。6 即“仅周末”。",
  rule_dayOfWeek: "最晚星期",
  rule_dayOfWeek_help: "1 为周一，7 为周日。5 即“仅工作日”——周末不交易。",
  rule_momentum20dPctMax: "最高动量",
  rule_momentum20dPctMax_help: "上限形式：窗口内的涨跌幅至多为此。周期设为 4、小时线上取 −10，即“最近 4 小时下跌 10% 或更多”。周期即你所指的窗口。",
  rule_breakHighPct: "高于前高至少",
  rule_breakHighPct_help: "最新收盘价相对前 N 根 K 线最高价。0 即突破——创 N 根新高。小时线上“突破昨日高点”周期为 24；日线上“7 日新高”周期为 7。",
  rule_breakLowPct: "高于前低至多",
  rule_breakLowPct_help: "最新收盘价相对前 N 根 K 线最低价。0 或以下即创 N 根新低；2 表示收盘价在前低 2% 以内。",
  rule_priceCrossEmaUpBars: "价格上穿 EMA 于",
  rule_priceCrossEmaUpBars_help: "收盘价上穿 N 周期 EMA 距今几根 K 线。这是事件，与均线下穿相同——周期设为你所指的 EMA。",
  rule_priceCrossEmaDownBars: "价格下穿 EMA 于",
  rule_priceCrossEmaDownBars_help: "收盘价下穿 N 周期 EMA 距今几根 K 线。EMA 策略最自然的卖出信号。",
  rule_priceCrossSmaUpBars: "价格上穿均线于",
  rule_priceCrossSmaUpBars_help: "收盘价上穿 N 周期简单移动平均距今几根 K 线。“突破 50 日均线”周期为 50。",
  rule_priceCrossSmaDownBars: "价格下穿均线于",
  rule_priceCrossSmaDownBars_help: "收盘价下穿 N 周期简单移动平均距今几根 K 线。",
