...
export const enAgentDetail = {
  ...
  // ── Copy LP rail: who it copies and on what terms ─────────────
  ad_copy_title: "Copying",
  ad_copy_edit: "Edit copy",
  ad_copy_leader: "Leader",
  ad_copy_copy: "Copy",
  ad_copy_copied: "Copied",
  ad_copy_leader_now: "{amount} in {count} DLMM positions · {inRange} in range",
  ad_copy_leader_now_one: "{amount} in 1 DLMM position · {inRange} in range",
  ad_copy_leader_flat: "No open DLMM positions right now",
  ad_copy_terms: "Terms",
  ad_copy_size: "Copy size",
  ad_copy_size_value: "{pct}% of each leader position",
  ad_copy_max: "Max per position",
  ad_copy_no_cap: "No cap",
  ad_copy_tp: "Take profit",
  ad_copy_sl: "Stop loss",
  ad_copy_off: "Off",
  ad_copy_range: "Range moves",
  ad_copy_followed: "Followed",
  ad_copy_not_followed: "Not followed",
  ad_copy_pools: "Pools",
  ad_copy_pools_verified: "Verified tokens",
  ad_copy_pools_tvl: "TVL ≥ {tvl}",
  ad_copy_any_pool: "Any pool",
  ad_copy_slippage: "Slippage",
