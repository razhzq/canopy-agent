...
export const enEquity = {
  ...
  equity_by_token: "By token",
  equity_by_token_split: "{winners} up · {losers} down ·",
  equity_by_token_page: "{from}–{to} of {count}",
  equity_by_token_prev: "Previous tokens",
  equity_by_token_next: "Next tokens",
  equity_by_token_close: "Close By token",
  equity_by_token_empty: "No closed trades in this window yet.",
  equity_by_token_error: "Couldn't load the per-token figures.",
