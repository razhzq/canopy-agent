...
export const enLimits = {
  ...
  sl_caps: "Guardrails",
  sl_caps_note: "Account-wide, entries only",
  sl_caps_info:
  ...
  sl_cap_daily: "Daily loss limit",
  sl_cap_daily_info: "Once the book is down this much from where it started the UTC day, no new positions until tomorrow. Exits still run.",
  sl_cap_daily_help: "Pauses new entries after a {usd} loss on the day",
  sl_cap_cooldown: "Cool-down after losses",
  sl_cap_cooldown_info: "After this many losing closes in a row, no new positions for the chosen time. A win resets the count.",
  sl_cap_cooldown_help: "{losses} losses in a row → no new entries for {minutes} min",
  sl_cap_unit_losses: "losses",
  sl_cap_hours: "{n}h",
  sl_cap_minutes: "{n}m",
