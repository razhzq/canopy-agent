...
export const enSettings = {
  ...
  tg_kind_fill: "Trades",
  tg_kind_fill_note: "Every fill, with the result on a sale.",
  tg_kind_proposal: "Decisions",
  tg_kind_proposal_note: "Plans waiting on you, with Approve and Reject.",
  tg_kind_risk_hold: "Freezes",
  tg_kind_risk_hold_note: "When an agent stops opening and when it resumes.",
  tg_kind_alert: "Heads up",
  tg_kind_alert_note: "A held market turned, a model outage, a failed cycle.",
  tg_kind_discovery: "New pools",
  tg_kind_discovery_note: "A brand-new pool passed a discovery screen.",
  tg_kind_digest: "Daily digest",
  tg_kind_digest_note: "Every running agent, once a day.",
  tg_kind_breach: "Stops",
  tg_kind_breach_note: "A drawdown limit hit, a liquidation.",
  tg_always: "always",
  tg_quiet_label: "Quiet hours, UTC",
  tg_quiet_to: "to",
  tg_quiet_note: "Messages wait until the window ends. Stops still come through.",
  tg_digest_label: "Digest at, UTC",
  tg_digest_note: "The same summary as /status in the chat.",
  tg_off: "Off",
