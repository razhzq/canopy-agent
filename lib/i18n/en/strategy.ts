...
export const enStrategy = {
  ...
  rule_btcTrendPct: "Min BTC trend",
  rule_btcTrendPct_help: "BTC's own 20/50 average spread, percent. 0 is 'only when BTC is in an uptrend'.",
  rule_btcTrendPctMax: "Max BTC trend",
  rule_btcTrendPctMax_help: "The ceiling form: 0 is 'only when BTC is in a downtrend'.",
  rule_btcChangePct: "Max BTC day change",
  rule_btcChangePct_help: "BTC's move over the last 24 hours of bars. 0 is 'only when BTC is down on the day'.",
  rule_btcChangePctMin: "Min BTC day change",
  rule_btcChangePctMin_help: "0 is 'only when BTC is up on the day'.",
  rule_solTrendPct: "Min SOL trend",
  rule_solTrendPct_help: "SOL's own 20/50 average spread. 0 is 'only when SOL is in an uptrend'.",
  rule_solTrendPctMax: "Max SOL trend",
  rule_solTrendPctMax_help: "The ceiling form: 0 is 'only when SOL is in a downtrend'.",
  rule_solChangePct: "Max SOL day change",
  rule_solChangePct_help: "SOL's move over the last 24 hours of bars. 0 is 'only when SOL is down on the day'.",
  rule_solChangePctMin: "Min SOL day change",
  rule_solChangePctMin_help: "0 is 'only when SOL is up on the day'.",
  rule_relativeStrengthBtcPct: "Min strength vs BTC",
  rule_relativeStrengthBtcPct_help: "The token's change minus BTC's over the window. 0 is 'outperforming BTC'. Set the period for another window.",
  rule_relativeStrengthBtcPctMax: "Max strength vs BTC",
  rule_relativeStrengthBtcPctMax_help: "0 is 'underperforming BTC' — lagging it over the window.",
  rule_relativeStrengthSolPct: "Min strength vs SOL",
  rule_relativeStrengthSolPct_help: "The token's change minus SOL's over the window. 0 is 'outperforming SOL'.",
  rule_relativeStrengthSolPctMax: "Max strength vs SOL",
  rule_relativeStrengthSolPctMax_help: "0 is 'underperforming SOL'.",
  rule_bullishEngulfingBars: "Bullish engulfing within",
  rule_bullishEngulfingBars_help: "How many bars ago a bullish engulfing candle closed — a green body covering the previous red one. 0 is the last bar; 1 is the last bar or the one before.",
  rule_bearishEngulfingBars: "Bearish engulfing within",
  rule_bearishEngulfingBars_help: "How many bars ago a bearish engulfing candle closed. More often a sell signal than an entry.",
  rule_hammerBars: "Hammer within",
  rule_hammerBars_help: "How many bars ago a hammer (pin bar) closed — a lower wick at least twice the body, the body near the top of the range.",
  rule_shootingStarBars: "Shooting star within",
  rule_shootingStarBars_help: "How many bars ago a shooting star closed — the mirror of a hammer, a long upper wick.",
  rule_dojiBars: "Doji within",
  rule_dojiBars_help: "How many bars ago a doji closed — a body a tenth of the bar's range or less.",
  rule_insideBarBars: "Inside bar within",
  rule_insideBarBars_help: "How many bars ago an inside bar closed — a bar held within the previous bar's high and low.",
