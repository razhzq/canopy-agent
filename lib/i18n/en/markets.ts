...
export const enMarkets = {
  ...
  dsc_group_live: "Right now",
  dsc_group_live_note:
    "Checked on figures seconds old, for the deepest tokens that passed everything above.",
  dsc_launchAgeMinutes: "Launch age",
  dsc_launchAgeMinutes_note: "Minutes since the pool was created, from the chain.",
  dsc_volume5mUsd: "5m volume",
  dsc_txns5m: "5m trades",
  dsc_buySellRatio5m: "5m buys per sell",
  dsc_liquidityGrowthPct: "Liquidity growth",
  dsc_liquidityGrowthPct_note: "Against what the pool opened with. Negative means liquidity is leaving.",
  dsc_holderCount: "Holders",
  dsc_top10HolderPct: "Top 10 holders own",
  dsc_top10HolderPct_note: "Share of supply in the ten largest wallets. Lower is better spread.",
  dsc_creatorHoldingPct: "Creator still holds",
  dsc_creatorHoldingPct_note: "Share of supply the wallet that created the pool still has.",
  dsc_sellImpactPct: "Cost to sell $100",
  dsc_sellImpactPct_note: "What a $100 round trip loses to the pool right now, in percent.",
  dsc_require_sellable: "Can actually be sold",
  dsc_require_sellable_note:
    "A $100 buy and sell-back both route through Jupiter right now. Tokens that fail are left out.",
  dsc_summary_sellable: "sellable",
  dsc_unit_minutes: "min",
  dsc_min: "At least",
  dsc_max: "At most",
  dsc_any: "Any",
