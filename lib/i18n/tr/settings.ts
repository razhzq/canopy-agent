...
export const trSettings: Record<keyof typeof enSettings, string> = {
  ...
  tg_kind_fill: "İşlemler",
  tg_kind_fill_note: "Her dolum, satışta sonucuyla.",
  tg_kind_proposal: "Kararlar",
  tg_kind_proposal_note: "Seni bekleyen planlar, Onayla ve Reddet ile.",
  tg_kind_risk_hold: "Dondurmalar",
  tg_kind_risk_hold_note: "Bir ajan açmayı bıraktığında ve sürdürdüğünde.",
  tg_kind_alert: "Dikkat",
  tg_kind_alert_note: "Tutulan bir piyasa döndü, model kesintisi, başarısız döngü.",
  tg_kind_discovery: "Yeni havuzlar",
  tg_kind_discovery_note: "Yepyeni bir havuz keşif taramasını geçti.",
  tg_kind_digest: "Günlük özet",
  tg_kind_digest_note: "Çalışan her ajan, günde bir kez.",
  tg_kind_breach: "Durdurmalar",
  tg_kind_breach_note: "Bir düşüş limiti aşıldı, bir tasfiye.",
  tg_always: "her zaman",
  tg_quiet_label: "Sessiz saatler, UTC",
  tg_quiet_to: "—",
  tg_quiet_note: "Mesajlar pencere bitene kadar bekler. Durdurmalar yine gelir.",
  tg_digest_label: "Özet saati, UTC",
  tg_digest_note: "Sohbetteki /status ile aynı özet.",
  tg_off: "Kapalı",
