...
export const trEquity: Record<keyof typeof enEquity, string> = {
  ...
  equity_by_token: "Token bazında",
  equity_by_token_split: "{winners} kârda · {losers} zararda ·",
  equity_by_token_page: "{from}–{to} / {count}",
  equity_by_token_prev: "Önceki tokenlar",
  equity_by_token_next: "Sonraki tokenlar",
  equity_by_token_close: "Token bazında panelini kapat",
  equity_by_token_empty: "Bu aralıkta henüz kapanan işlem yok.",
  equity_by_token_error: "Token bazında rakamlar yüklenemedi.",
  ...
  equity_profit_factor: "Kâr faktörü",
  equity_fee_drag: "Ücret yükü",
  equity_fees_of_gross: "brüt kazancın %{pct}'i",
  equity_against: "yatırılan {capital} karşısında",
  equity_since: "{when} tarihinden beri",
  equity_range_24h: "24s",
  equity_range_7d: "7g",
  equity_range_all: "Tümü",
  equity_range_aria: "Pencere",
  equity_dd_span: "{from} → {to}",
  equity_needs_days: "bir haftalık veriden sonra",
  equity_hit_fraction: "{closed} işlemde {won}",
  equity_no_trades_yet: "henüz kapanan işlem yok",
  equity_no_losses_yet: "henüz zararlı işlem yok",
